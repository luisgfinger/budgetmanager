  ...
  return (
    <div id="sobre-items">
      <div className="sobre-container">
        ...
        <p>
          Estou começando minha jornada na área de desenvolvimento web,
          aprendendo cada dia mais sobre as tecnologias que moldam a web
          moderna. Tenho focado em aprimorar minhas habilidades em HTML, CSS,
          JavaScript e React, com o objetivo de criar aplicações funcionais e
          interativas.
        </p>
        <p>
          ...
          permitam evoluir como desenvolvedor.
        </p>
        <a
